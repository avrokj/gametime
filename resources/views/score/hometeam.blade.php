<x-app-layout>
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 p-8">
            <div class="card bg-neutral hover:scale-[1.01] hover:shadow-[0_9px_4px_-6px_rgba(0,0,0,0.3)]shadow-lg rounded-md p-4">
            ...
            <div class="card bg-neutral hover:scale-[1.01] hover:shadow-[0_9px_4px_-6px_rgba(0,0,0,0.3)]outline outline-offset-2 outline-[#ed8600] text-primary-content shadow-lg rounded-md p-4">
