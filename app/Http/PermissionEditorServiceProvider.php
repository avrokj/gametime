...
use App\Http\Middleware\SpatiePermissionMiddleware as MiddlewareSpatiePermissionMiddleware;
...
class PermissionEditorServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $router->aliasMiddleware('spatie-permission', MiddlewareSpatiePermissionMiddleware::class);
